...
INSERT INTO project(name, owner, finish_date, github, googleDrive, logo, personaNumber) VALUES('開発支援アプリ', '橋本俊平', '2024-01-15', 'https://github.com/Sansyou47/kd-develop-2023-team-J13.git', 'https://drive.google.com/drive/folders/0AOWOMUXeZizTUk9PVA', 'bird.png', 1);
INSERT INTO project(name, owner, finish_date, github, personaNumber) VALUES('タスク管理アプリ', '中井禅', '2024-01-15', 'https://github.com/Sansyou47/team-J13-shooting-range.git', 1);
INSERT INTO project(name, owner, finish_date, github, personaNumber) VALUES('シフト表作成支援アプリ', '嫁阪雄大', '2024-01-15', 'https://github.com/Sansyou47/PythonWebApp.git', 1);
INSERT INTO project(name, owner, finish_date, github, logo, personaNumber) VALUES('マインクラフトサーバー', '嫁阪雄大', '2024-01-15', 'https://github.com/Sansyou47/Minecraftserver-for-Docker.git', 'minecraft.png', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('音楽再生ソフト', '米津大也', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('音楽編集ソフト', '米津大也', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('音楽リミックスソフト', '米津大也', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, logo, personaNumber) VALUES('原神聖遺物計算アプリ', '中川浩太郎', '2024-01-15', 'java_logo.png', 1);
INSERT INTO project(name, owner, finish_date, logo, personaNumber) VALUES('原神ガチャ課金計算', '中川浩太郎', '2024-01-15', 'java_logo.png', 1);
INSERT INTO project(name, owner, finish_date, logo, personaNumber) VALUES('原神キャラクター育成計算', '中川浩太郎', '2024-01-15', 'java_logo.png', 1);
INSERT INTO project(name, owner, finish_date, logo, personaNumber) VALUES('原神武器育成計算', '中川浩太郎', '2024-01-15', 'java_logo.png', 1);
INSERT INTO project(name, owner, finish_date, logo, personaNumber) VALUES('原神素材計算', '中川浩太郎', '2024-01-15', 'java_logo.png', 1);
INSERT INTO project(name, owner, finish_date, logo, personaNumber) VALUES('ビジュネル暗号計算機', '林敦啓', '2024-01-15', 'lambda_logo.png', 1);
INSERT INTO project(name, owner, finish_date, logo, personaNumber) VALUES('ビジュネル暗号解読機', '林敦啓', '2024-01-15', 'lambda_logo.png', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('デレステキャラ育成計画表', '中井禅', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('デレステガチャ課金計算', '中井禅', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('デレステガチャ確率計算', '中井禅', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('デレステガチャユニット編成表', '中井禅', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('ブルアカロリボイス集', '橋本俊平', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('ブルアカガチャ課金計算', '橋本俊平', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('ブルアカガチャ確率計算', '橋本俊平', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, personaNumber) VALUES('ブルアカユニット編成表', '橋本俊平', '2024-01-15', 1);
INSERT INTO project(name, owner, finish_date, logo, personaNumber) VALUES('漫画感想共有アプリ', '山田真豊', '2024-01-15', 'flask_logo.png', 1);
INSERT INTO project(name, owner, finish_date, logo, personaNumber) VALUES('漫画価格一覧アプリ', '山田真豊', '2024-01-15', 'flask_logo.png', 1);
INSERT INTO project(name, owner, finish_date, logo, personaNumber) VALUES('漫画ガチャ課金計算', '山田真豊', '2024-01-15', 'flask_logo.png', 1);
